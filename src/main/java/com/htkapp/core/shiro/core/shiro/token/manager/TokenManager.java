package com.htkapp.core.shiro.core.shiro.token.manager;

import com.htkapp.core.customShiro.CusRealm;
import com.htkapp.core.customShiro.UserToken;
import com.htkapp.core.shiro.common.utils.SpringContextUtil;
import com.htkapp.core.shiro.core.shiro.session.CustomSessionManager;
import com.htkapp.core.shiro.core.shiro.token.SampleRealm;
...
public class TokenManager {
	//用户登录管理
	public static final CusRealm realm = SpringContextUtil.getBean("CusRealm",CusRealm.class);
	//用户session管理
	...
	public static Long getUserId(){
		return getToken()==null?null:Long.parseLong(getToken().getUserId().toString());
	}
	/**
	...
	public static LoginUser login(LoginUser user, Boolean rememberMe){
		UserToken token = new UserToken(user.getUserName(), user.getPassword(),user.getRole());
