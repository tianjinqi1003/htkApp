            ...
            ready: function () {
                ...
                if (startDateEle.val() === undefined || startDateEle.val() === "") {
                    ...
                    layer.msg("开始日期值不能为空,默认改为截止日期的前七天", {anim: 6, time: 2000}, function () {
                            ...
                            setTimeout(function () {
                                window.location.href = baseUrl + "/merchant/buffetFood/comment/index" + "?date=" + (startDateVal + "~" + stopDateEle.val()) + "&starRating=" + starVal;
                            }, 1500)
                        }
                    );
                    ...
                    //按照条件筛选评论数据
                    window.location.href = baseUrl + "/merchant/buffetFood/comment/index" + "?date=" + (startDateEle.val() + "~" + stopDateEle.val()) + "&starRating=" + starVal;
                }
            }
        });
...
//                        }
//                    })
                    window.location.href = baseUrl + "/merchant/buffetFood/comment/index" + "?date=" + curDateVal + "&starRating=" + starVal + "&pageNum=" + obj.curr;
                }
            }
        });
    ...
    $("div.dateTimeDiv > div.dateItemBtn > button").on("click", function () {
        ...
        var starVal = $(starCondition).attr("data-star");
        //携带当前条件查询数据
        window.location.href = baseUrl + "/merchant/buffetFood/comment/index" + "?date=" + dateVal + "&starRating=" + starVal;
    });
