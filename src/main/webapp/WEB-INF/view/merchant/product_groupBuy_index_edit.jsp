        ...
        <div class="body-content">
            <div class="crumbs">
                <div class="crumbsContiner clearfix">
                    ...
                    <i class="spacer">/</i>
                    <a href="${sysPath}merchant/groupBuy/product/getGroupBuyDetailById">修改商品</a>
                </div>
            </div>
            <div class="continerCont pdtp10">
                <div class="addFormCont">
                    <div class="formCont">
                        <form action="${sysPath}merchant/groupBuy/product/getGroupBuyDetailById" method="post"
                                ...
                                <div class="formList">
                                    <div class="formLine clearfix">
                                        ...
                                        <div class="formInput fontNum">
                                            <input type="text" name="packageName" placeholder="请输入团购标题" maxlength="20" value="${data.packageName}"/>
                                    ...
                                    <div class="formLine clearfix">
                                        ...
                                        <div class="formInput fontNum">
                                            <input type="text" name="peopleUsedNumber" placeholder="请输入消费人数"
                                                   maxlength="20" value="${data.peopleUsedNumber}" />
                                        </div>
                                    </div>
                                    <div class="formLine clearfix">
                                ...
                                <div class="">
                                    <div class="formLine clearfix">
                                        ...
                                        <div class="detailTab" style="margin-top: 15px;">
                                            ...
                                            <c:forEach items="${data.contentList}" var="each" varStatus="i">
                                                <div class="tabItem itemTab">
                                                    <div class="tabItem-left">
                                                        <span class="left">${each.productName}</span>
                                                        <span class="right">￥${each.price}</span>
                                                        <input hidden="hidden" name="list[${i.count}].productName" value="${each.productName}">
                                                        <input hidden="hidden" name="list[${i.count}].price" value="${each.price}">
                                                        <input hidden="hidden" name="list[${i.count}].productId" value="${each.productId}">
                                                    </div>
                                                    <div class="tabItem-right">
                                                        <span class="left">x1</span>
                                                        <input name="list[${i.count}].quantity" hidden="hidden" value="${each.quantity}">
                                                        <input name="list[${i.count}].originalCost" hidden="hidden" value="${each.originalCost}">                                                    <span class="right">￥0.1</span>
                                                    </div>
                                                </div>
                                            </c:forEach>
                                            <div class="tabItem endItem">
                                                <div class="tabItem-left">
                                                    <span class="left" style="font-size: 15px;font-weight: 600">总计:</span>
                                                </div>
                                                <div class="tabItem-right" style="width: 44%;">
                                                    <span class="left" style="font-size: 15px;font-weight: 600">共${fn:length(data.contentList)}件</span>
                                                    <span class="right" style="font-size: 15px;font-weight: 600">合计:${data.price}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="formLine clearfix">
                                        ...
                                        <div class="formInput fontNum">
                                            <input type="text" id="date" name="usageTime" placeholder="请选择消费时间"
                                                   maxlength="20" style="font-size: 15px;" value="${data.usageTime}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="formItem">
                                ...
                                <div class="formList">
                                    <textarea class="layui-textarea layui-hide" name="useDetails" lay-verify="content"
                                              id="LAY_demo_editor">${data.useDetails}</textarea>
                                </div>
                            </div>
                            <div class="subFrm">
                                <input type="submit" value="保存"/>
                                <input type="button" class="cancel" value="取消"/>
                                <input type="button" class="delete" value="删除" data-id="${data.id}"/>
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(".cancel").on("click", function () {
        window.location.href = baseUrl + "/merchant/groupBuy/product/homePage";
    })

    //删除按钮
    $(".delete").on("click", function () {
        var dataId = $(this).attr("data-id");
        const url = baseUrl + "/merchant/groupBuy/product/deleteGroupBuyById";
        var params = {
            id: dataId
        }
