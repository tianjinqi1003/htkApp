                ...
                <div class="content-child">
                    <div class="active-status active-com shadow_">
                        ...
                        <div class="btnGroup" style="display: inline-block">
                            ...
                            <a class="aItem cur" href="${sysPath}merchant/integral/getExitsActiveProcessPage">进行中</a>
                                                ...
                                                <div class="layui-col-md6 btnGroup" style="text-align: right">
                                                    <div style="padding-top: 12px;">
                                                        ...
                                                        <div class="btn-item" style="display: inline-block;margin-left: 5px;">
                                                            <button class="layui-btn layui-btn-primary obsolete" data-id="${each.id}">作废活动</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    $(".obsolete").on("click", function () {
        ...
        const url = baseUrl + "/merchant/integral/obsoleteActivity";
        $.post(url, {id: id},function (result, status) {
            if(status === 'success'){
                if(result && result.code === 0){
                    window.location.href = baseUrl + "/merchant/integral/getExitsActiveProcessPage";
                }else {
