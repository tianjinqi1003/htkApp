 ...
 * @param options
 */
$.htk.prototype.alertOk = function (options) {
 ...
 * @param text
 */
$.htk.prototype.alertOkAndReload = function (text) {
 ...
 * @param options
 */
$.htk.prototype.alertWarn = function (options) {
    options = options.length ? {text:options} : ( options || {} );
 ...
 * @param options
 */
$.htk.prototype.alertConfirm = function (options) {
    options = options || {};
 ...
 * @param options
 */
$.htk.prototype.alertError = function (options) {
    options = options.length ? {text:options} : ( options || {} );
 ...
 * @param options
 */
$.htk.prototype.alertBox = function (options) {
    swal({
        title: options.title,
        text: options.text,
        type: options.type,
 ...
 * @param options   参数
 */
$.htk.prototype.post = function (options) {
    var self = this;
    $.ajax({
        type: 'POST',
        url: options.url,
 ...
 * 显示动画
 */
$.htk.prototype.showLoading = function () {
 ...
 * 隐藏动画
 */
$.htk.prototype.hideLoading = function () {
