!function ($) {
    ...
    Sidemenu.prototype.openLeftBar = function () {
        ...
        if (localStorage.sidemenuState == 0 || typeof(localStorage.sidemenuState) == 'undefined') {
            ...
            ele.empty();
            //添加内容
            ele.prepend('<div class="pull-left" style="padding-left: 10px;">' +
                '<a href="/admin/index" style="color: #FFFFFF">' +
                '<i class="fa fa-television fa-5" style="font-size: 3em" aria-hidden="true"></i>' +
                '</a>' +
                '</div>');
            ...
            //添加内容
            ele.prepend('<div class="pull-left" style="padding-left: 10px;">' +
                '<span class="text_color" style="font-size: 28px;line-height: 50px;">回头客管理中心</span>' +
                '</div>');
...
function getRootUrl() {
    ...
    var curUrl = window.document.location.pathname;
    var pos = rootUrl.indexOf(curUrl);
    var localhost = rootUrl.substring(0,pos);
    var projectName = curUrl.substring(0,curUrl.substr(1).indexOf('/')+1);
